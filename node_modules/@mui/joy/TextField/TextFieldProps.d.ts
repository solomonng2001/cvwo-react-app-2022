...
type InputRootKeys = 'autoComplete' | 'autoFocus' | 'disabled' | 'error' | 'required' | 'fullWidth' | 'placeholder' | 'defaultValue' | 'value' | 'onChange' | 'onFocus' | 'onBlur' | 'type' | 'variant' | 'color' | 'size' | 'startDecorator' | 'endDecorator' | 'sx';
...
export type TextFieldProps<D extends React.ElementType = TextFieldTypeMap['defaultComponent'], P = {
